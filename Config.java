...
public class Config {
  public final static String DATAPATH = ""; // If you don't know what the static keyword does, you better go look it up now.
  public static String APPLICATIONNAME = "Phase Two";
  public static String PRIMEFILNAME = "primesFile";
  public static String CROSSFILENAME = "crossFile";
